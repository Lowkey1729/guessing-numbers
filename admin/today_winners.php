...
<?php $user = new Users(); ?>
<title>Today Winners|Guess~Right</title>
</head>
<?php
  global $db;
  $status = '';
  $query = " SELECT * FROM userwins WHERE DATE(WinDate) = CURDATE() ORDER BY id DESC";
...
<div class="content-wrapper">
  <div class="content">
      ...
      ?>
      <h1 align="center" style="color: #fff; background: #111111;">***Today Winners***</h1>
      <hr>
