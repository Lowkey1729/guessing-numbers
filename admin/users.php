...
<title>New Users|Guess~Right</title>
</head>
<?php
  global $db;
  $query = " SELECT * FROM user WHERE DATE(created_at) = CURDATE()";
...
<div class="content-wrapper">
  <div class="content">
      ...
      ?>
      <h1 align="center" style="color: #fff; background: #111111;">***New Users***</h1>
      <hr>
...
<?php include('includes/manage_users_modal.php'); ?>
