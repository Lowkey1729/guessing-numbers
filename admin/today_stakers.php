...
<title>Today Stakers</title>
</head>
<?php
$user = new Users();
	global $db;
	$query = " SELECT * FROM bets WHERE DATE(EnterTime) = CURDATE() ORDER BY id DESC";
...
<div class="content-wrapper">
  <div class="content">
      ...
      ?> 
      <h1 style="color: #fff; background: #111111;" align="center"> ***Today Stakers*** </h1>
      <hr>
